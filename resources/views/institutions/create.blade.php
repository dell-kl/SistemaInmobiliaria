...
<div class="container mt-5">
    <h1 class="text-5xl font-bold logo">Crear Institución</h1>
    <hr class="my-4">
    ...
    <div class="table-responsive shadow-sm p-3 mb-5 bg-white rounded">
        <form action="{{ route('institutions.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="institutions_name" id="institutions_name" required>
            </div>
            <div class="mb-3">
                <label for="institutions_terms" class="form-label">Términos</label>
                <input type="text" class="form-control" name="institutions_terms" id="institutions_terms" required>
            </div>
            <div class="mb-3">
                <label for="institutions_dateRegist" class="form-label">Fecha de Registro</label>
                <input type="date" class="form-control" name="institutions_dateRegist" id="institutions_dateRegist" required>
            </div>
            <div class="mb-3">
                <label for="interests_rate" class="form-label">Tasa de Interés</label>
                <input type="number" step="0.01" class="form-control" name="interests_rate" id="interests_rate" required>
            </div>
