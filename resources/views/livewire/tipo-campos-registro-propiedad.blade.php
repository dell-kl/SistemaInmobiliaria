<div class="formularioRegistroPropiedad w-50">
    ...
    <div class="campos mt-2">
        ...
        @if ( intval($typeProjects) !== 0 )
            ...
            <div class="flex flex-row flex-wrap gap-1">
                <div class="form-floating mb-3  flex-1">
                    <input type="text" wire:input="actualizarValidaciones" wire:model.lazy="area" name="AreaProyecto" value="{{ isset($datosPropiedad) ? $datosPropiedad['properties_area'] : '' }}" class="form-control w-100  @error('area') border border-danger @enderror" id="floatingInput" placeholder="Inserta el area del proyecto">
            ...
            <div class="flex flex-row flex-wrap gap-1">
                <div class="form-floating flex-1">
                    <select name="EstadoProyecto" wire:blur="actualizarValidaciones" wire:model.lazy="disponibilidadProyecto" class="form-select @error('disponibilidadProyecto') border border-danger @enderror" id="floatingSelect" aria-label="Floating label select example">
            ...
            <div class="flex flex-row flex-wrap gap-1">
                <div class="form-floating mb-3  flex-1">
                    <input type="number" wire:input="actualizarValidaciones" wire:model.lazy="precioProyecto" name="PrecioProyecto" value="{{ isset($datosPropiedad) ? $datosPropiedad['properties_price'] : '' }}" class="form-control w-100  @error('precioProyecto') border border-danger @enderror" id="floatingInput" placeholder="Precio propuesto del proyecto">
            ...
            <div class="flex flex-row flex-wrap gap-1">
                <div class="form-floating mb-3  flex-1">
                    <input type="text"
                        wire:input="actualizarValidaciones"
                        wire:model.lazy="codigosVideoYoutube"
                        name="VideosProyecto"
                        value="{{$codigosVideoYoutube}}"
                        class="form-control w-100
                        @error('codigosVideoYoutube') border border-danger @enderror"
                        id="floatingInput"
